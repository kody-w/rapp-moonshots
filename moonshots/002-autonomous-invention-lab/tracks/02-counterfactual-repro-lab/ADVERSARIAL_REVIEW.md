...
| “Temporary trials pollute the machine.” | Medium | Workspaces are under this track's ignored `.runtime/` and uniquely named. Deletion errors or surviving paths raise `WorkspaceCleanupError`; no completed receipt is returned. The measured 36/36 verified deletions left zero residue. |
